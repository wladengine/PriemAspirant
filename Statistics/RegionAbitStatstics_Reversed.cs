...
namespace Priem
{
    public partial class RegionAbitStatstics_Reversed : Form
    {
        ...
        {
            string query = @"
                SELECT extAbitAspirant.FacultyName, extAbitAspirant.StudyBasisId, COUNT(extAbitAspirant.Id) AS CNT_Abit, COUNT(DISTINCT extAbitAspirant.PersonId) AS CNT_Person
                ...
                WHERE extAbitAspirant.StudyLevelGroupId=@StudyLevelGroupId AND extPersonAspirant.RegionId=@RegionId";
            string groupby = " GROUP BY extAbitAspirant.FacultyName, extAbitAspirant.StudyBasisId ";
            ...
            query = @"
SELECT extAbitAspirant.FacultyName, extAbitAspirant.StudyBasisId, MIN(hlpStatMarksSum.SUM) AS MinSUM, AVG(convert(float,hlpStatMarksSum.SUM)) AS AvgSUM, MAX(hlpStatMarksSum.SUM) AS MaxSUM
...
WHERE extPersonAspirant.RegionId=@RegionId AND extAbitAspirant.StudyLevelGroupId=@StudyLevelGroupId";
            sl.Clear();
            sl.Add("@StudyLevelGroupId", MainClass.studyLevelGroupId);
            sl.Add("@RegionId", RegionId);
            ...
            groupby = " GROUP BY extAbitAspirant.FacultyName, extAbitAspirant.StudyBasisId ";
